...
public class Utility 
{
	 ...
	 */
	public static double harmonicNumber(double endPoint) 
	{
		double answer = 0;
		double count = 0;
	...
	public static void GamlingSimulator()
	{
		double stake, goal;//done
		int trails = 0, temp = 0;
		double compare;
		double percentage;
		int win = 0, choice;
		System.out.println("Enter Your Stake Amount");
		stake = Utility.scanDouble();
		System.out.println("Enter Maximum Win Amount");
		goal = Utility.scanDouble();
